...
hint.Text = "i loved roblox sharkey ur ass at everything lOL"
...
coroutine.wrap(function()
    ...
    if Version == ClientVersion then
        Notification("wisteria of poop made by rent", 5)
        Notification("Wisteria", "pooop", 2)
    else
        Notification("Wisteria", "make sure to say thanks to rent", 10)
        setclipboard("nigger")
    end
end)()
